...
import { Sparkles, Star, ShieldCheck, Truck, Gift } from "lucide-react";
      ...
      <div className="relative grid lg:grid-cols-2 min-h-screen">
        ...
        <aside className="hidden lg:flex relative overflow-hidden bg-gradient-to-br from-primary-500 via-primary-600 to-primary-800 text-white p-12 flex-col justify-between">
          ...
          <div className="relative space-y-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/15 backdrop-blur-sm border border-white/20 text-xs font-medium">
            ...
            <p className="text-white/85 text-lg max-w-md leading-relaxed">
              Members get early access to drops, member-only deals, and a
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4">
              {[
                { Icon: Gift, label: "15% off welcome" },
          ...
          <div className="relative flex items-center gap-2 text-xs text-white/60">
            ...
            <span>Welcome code applied at checkout automatically</span>
          </div>
        </aside>
